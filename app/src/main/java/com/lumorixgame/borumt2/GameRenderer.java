...
public class GameRenderer implements GLSurfaceView.Renderer {
 float[] p=new float[16],v=new float[16],m=new float[16],mv=new float[16]; float yaw=0,pitch=.12f; Player player=new Player(); NPC npc1=new NPC("Ticaret Yöneticisi",-3,0.7f,-3); NPC npc2=new NPC("Emlakçı",3,0.7f,-4); int prog,pos,col,mat;
 FloatBuffer ground;
