...
public class GameRenderer implements GLSurfaceView.Renderer {
 ...
 public void onDrawFrame(GL10 g){GLES20.glClear(GLES20.GL_COLOR_BUFFER_BIT|GLES20.GL_DEPTH_BUFFER_BIT);float cx=(float)Math.sin(yaw)*7,cz=(float)Math.cos(yaw)*7,cy=3.2f+pitch*2;Matrix.setLookAtM(v,0,playerX+cx,cy,playerZ+cz,playerX,1,playerZ,0,1,0);cube(playerX,.75f,playerZ,.55f,.75f,.35f,.75f,.55f,.35f);cube(playerX,1.75f,playerZ,.45f,.45f,.45f,.75f,.62f,.42f);cube(-3,.7f,-3,.5f,.7f,.35f,.55f,.45f,.72f);cube(3,.7f,-4,.5f,.7f,.35f,.55f,.45f,.72f);ground();}
